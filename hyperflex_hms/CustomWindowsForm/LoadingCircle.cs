...
namespace CustomWindowsForm
{
    public partial class LoadingCircle : Control
    {
        ...
        private const int DefaultOuterCircleRadius = 24;
        private const int DefaultNumberOfSpoke = 20;
        private const int DefaultSpokeThickness = 5;
        private readonly Color DefaultColor = Color.DarkGray;

        private const int MacOSXInnerCircleRadius = 20;
        private const int MacOSXOuterCircleRadius = 24;
